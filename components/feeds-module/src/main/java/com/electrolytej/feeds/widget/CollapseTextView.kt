...
//        android:lineSpacingMultiplier="1.2"
        etvContent.setLineSpacing(ConvertUtils.dp2px(1f).toFloat(), 1.2f)
        ...
        etvContentLp.bottomMargin = ConvertUtils.dp2px(4f)
...
//        addView(tvCollapse,tvCollapseLp)
    ...
    fun setText(text: String?) {
        ...
        if (totalLines > contentMaxLine) {
            ...
            tvCollapse.visibility = VISIBLE
        } else {
            tvCollapse.visibility = GONE
        }
