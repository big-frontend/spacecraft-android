package com.electrolytej.bundle2.page.bottomupDialog
...
class BottomUpActivity : AppCompatActivity() {
    ...
    val dialogFragment =
        BottomUpDialogFragment.newInstance()
    val dialogFragment2 =
        BottomUpDialogFragmentv2.newInstance()
    val rnFragment = RNFragment.newInstance()
    val bottomUpDialogFragmentForSheet =
        BottomUpDialogFragmentForSheet.newInstance()
