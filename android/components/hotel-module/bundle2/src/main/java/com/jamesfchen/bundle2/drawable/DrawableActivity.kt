package com.jamesfchen.bundle2.drawable
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            val view = when (drawable[position]) {
                "bitmap" -> {
                    ...
                    view.findViewById<Button>(R.id.bt_scr_multiply).background = resources.getDrawable(
                        R.drawable.bitmap
                    ).apply {
                        setTintMode(PorterDuff.Mode.MULTIPLY)
                    }

                    view.findViewById<Button>(R.id.bt_scr_screen).background = resources.getDrawable(
                        R.drawable.bitmap
                    ).apply {
