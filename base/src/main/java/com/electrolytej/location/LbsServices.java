...
public class LbsServices extends Service {
    ...
    public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            notificationIntent.setClassName(this,"MapActivity");
            ...
            Notification notification = new Notification.Builder(this, channelId)
                    ...
                    .setSmallIcon(R.drawable.avd_anim)
...
//                            case 7:{locationTypeStr = "离线定位结果";}
                        ...
                        Log.d(Constants.TAG, "IntentService onLocationChanged: locationType:"+locationTypeStr+" location" + latitude + " , " + longitude+"");
                        ...
                        Log.e(Constants.TAG, "location Error, ErrCode:"
    ...
    private void realRequestLocation() {
        ...
        Log.d(Constants.TAG, "onHandleIntent: enable provider:" + enableProviders.toString());
        Log.d(Constants.TAG, "onHandleIntent: all provider:" + allProviders);
        String choice;
        ...
        Log.d(Constants.TAG, "onHandleIntent: choice provider:" + choice);
        locationManager.requestLocationUpdates(choice, Constants.MIN_TIMES, Constants.MIN_DISTANCE, new LocationListener() {
            @Override
            public void onLocationChanged(Location location) {
                Log.d(Constants.TAG, "IntentService onLocationChanged: location" + location.getLatitude() + " , " + location.getLongitude());
                if (iLbsApi.listenerlist == null) return;
                final int N = iLbsApi.listenerlist.beginBroadcast();
                for (int i = 0; i < N; i++) {
                    ILbsListener l = iLbsApi.listenerlist.getBroadcastItem(i);
