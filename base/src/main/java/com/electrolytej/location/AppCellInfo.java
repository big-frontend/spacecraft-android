...
//            Log.d(LBS.Constants.Constants.TAG, "ollection app cell info GsmCellLocation-->" + cellInfo2.toString());
...
//            Log.d(LBS.Constants.Constants.TAG, "ollection app cell info CdmaCellLocation-->" + cellInfo2.toString());
        }
        return cellInfo2;
...
//            cellInfo2.mnc = Integer.parseInt(mccMnc[1]);
            cellInfo2.radio_type = "cdma";
//            Log.d(LBS.Constants.Constants.TAG, "collection app cell info cdma-->" + cellInfo2.toString());
...
//            Log.d(LBS.Constants.Constants.TAG, "collection app cell info lte-->" + cellInfo2.toString());
        } else if (!(cellInfo instanceof CellInfoWcdma) || Build.VERSION.SDK_INT < 18) {
//            Log.d(LBS.Constants.Constants.TAG, "collection app cell  info unknown: " + cellInfo2.toString());
        } else {
            try {
...
//                Log.d(LBS.Constants.Constants.TAG, "collection app cell info wcdma-->" + cellInfo2.toString());
            } catch (Exception e) {
//                Log.d(LBS.Constants.Constants.TAG, e.getMessage());
            }
        }
        return cellInfo2;
    }
