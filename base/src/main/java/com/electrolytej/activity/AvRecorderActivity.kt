...
import com.electrolytej.av.AvRecorderService
import com.electrolytej.av.recorder.VideoRecorder
import com.electrolytej.base.R
import com.electrolytej.base.databinding.ActivityRecoderBinding
import java.io.File
 ...
 */
class AvRecorderActivity : Activity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btStopRecodingSceen.setOnClickListener { theView ->
            AvRecorderService.stopService(this)
...
//            vv_video.start()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent) {
        if (requestCode == REQUEST_MEDIA_PROJECTION) {
            ...
            AvRecorderService.startService(this, service)
        }
    }
