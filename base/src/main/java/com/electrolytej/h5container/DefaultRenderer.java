package com.electrolytej.h5container;
...
public class DefaultRenderer extends BaseGLRenderer {
    ...
    public DefaultRenderer(Context context, int width, int height) {
        super(width, height);
    ...
    private String getVertexShader() {
        return ResourceUtils.readRaw2String(R.raw.vertex_shader);
    }

    private String getFragmentShader() {
        return ResourceUtils.readRaw2String(R.raw.rect_fragment_shader);
    }
