...
import com.jamesfchen.rules.AndroidLogDetector
import com.jamesfchen.rules.DangerousApiDetector
import com.jamesfchen.rules.SampleCodeDetector
...
class IssueRegistry : com.android.tools.lint.client.api.IssueRegistry() {
  ...
  override val issues
    get() = listOf(
      DangerousApiDetector.ISSUE, AndroidLogDetector.ISSUE, SampleCodeDetector.ISSUE,
