...
object MemoryUtil {
    val am:ActivityManager? by lazy {
        ContextCompat.getSystemService(ViMonitor.app, ActivityManager::class.java)
    }
//
//    //android4.4版本以下都被认为低ram设备
    val isLowRamDevice = am?.isLowRamDevice
    val hasLargeHeap = ViMonitor.app.applicationInfo.flags and ApplicationInfo.FLAG_LARGE_HEAP != 0
