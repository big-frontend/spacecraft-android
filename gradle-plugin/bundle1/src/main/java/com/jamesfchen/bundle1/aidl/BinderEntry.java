...
import static com.jamesfchen.bundle1.aidl.Constants.DESCRIPTOR;
import static com.jamesfchen.bundle1.aidl.Constants.TRANSACTION_basicTypes;
...
public class BinderEntry extends Binder implements IMyAidlInterface {
    ...
    public int basicTypes(int anInt, long aLong, boolean aBoolean, float aFloat, double aDouble, String aString) {
